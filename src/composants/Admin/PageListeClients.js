                        ...
                        return (
                            <TableRow className="text-start" key={client.id}>
                                ...
                                <TableCell className="text-center">
                                    {client.estActif === 1 ? (<Link onClick={() => disableClient()}><CheckCircleOutlineOutlinedIcon /></Link>
                                    ) : (<Link onClick={() => enableClient()}><HighlightOffIcon /></Link>)
                                    }
                                    <Link onClick={() => (connexionData.idPersonnel) ? handleModifyClient(client) : handleActivateClient(client)}><EditIcon className='idPointerMouse' /></Link>
                                    {!connexionData.idPersonnel && <Link onClick={() => openInPopup(client)}><DeleteForeverOutlinedIcon className='idPointerMouse' />
                                    </Link>}
                                </TableCell>
                            </TableRow>
                        )
                ...
                <Grid container className='justify-content-center mtop-20'>
                    ...
                    />
                        ...
                        {(connexionData.idPersonnel) && <div className="text-start mtop-40 mb-3">
                            <h5>Ajouter un nouveau client &nbsp;&nbsp;&nbsp; <Link><AddCircleOutlineIcon className='idPointerMouse' onClick={handleClickOpen} /></Link></h5>
                        </div>}
