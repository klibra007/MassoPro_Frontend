...
export default function PageListeService() {
...
//                         <Card.Body>
//                             <Card.Text className='text-aleft'>
//                                 id: {props.idPersonnel}<br />
//                                 Service: {props.idService}<br />
//                                 Description: {props.duree}<br />                                
//                                 <br />
//                             </Card.Text>
//                         </Card.Body>
//                     </Card>
